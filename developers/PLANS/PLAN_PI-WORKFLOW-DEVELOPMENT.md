...
10. 阶段 9-12 后续仍可继续补更多专用端到端测试与真实 PI 宿主对接，但不影响当前主链路状态。
...
- 验收时间：2026-05-27（更新到阶段 12）
- 技术栈：TypeScript、Node.js workspace、Vitest、CLI
- 目标完成情况：阶段 0-12 已形成可用主链路，`@pi-workflow/core` 与 CLI 已覆盖 DSL、runtime、resume、agent、通用节点、authoring、debug、PI 集成、自定义智能体、软件安全策略与 PWB bundle 运行态。
